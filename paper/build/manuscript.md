...
A larger configuration of the same architecture — 86× the parameters, trained on more patches for more epochs — improved validation loss and gave the best PSNR in the study, 28.77 dB, while lowering detectability from 5.31 to 4.96.
...
5. Confirmation of the divergence and of the ceiling on real low-dose CT — twelve liver cases,
   ...
   86× in parameters — showing that the same divergence was also
