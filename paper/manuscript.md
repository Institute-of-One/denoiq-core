...
Raising network capacity [[results:real_liver.json:capacity.parameter_ratio|.0f]]-fold improved validation loss and
gave the best PSNR in the study, [[results:real_liver.json:capacity.large.psnr|.2f]] dB, while lowering
detectability from [[results:real_liver.json:capacity.small.d_prime|.2f]] to [[results:real_liver.json:capacity.large.d_prime|.2f]].
